...
WebUI.setText(findTestObject('Object Repository/Register/Page_kasirAja/inputname'), nama_toko)

WebUI.setText(findTestObject('Object Repository/Register/Page_kasirAja/inputemail'), 'rif@qa.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Register/Page_kasirAja/inputpassword'), '5xx1bkCcAlw=')
